...
/**
 * Find or create a user by email using pure Drizzle ORM.
 */
...
/**
 * Fetch user by email using pure Drizzle ORM.
 */
...
/**
 * Fetch all users along with their claimed products using pure Drizzle ORM.
 */
